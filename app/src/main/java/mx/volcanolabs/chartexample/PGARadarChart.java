 ...
 */
public class PGARadarChart extends RadarChart {
    ...
    public PGARadarChart(Context context) {
        super(context);
    }

    public PGARadarChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PGARadarChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new PGARadarChartRenderer(this, mAnimator, mViewPortHandler);
    ...
    protected void calcMinMax() {
        ...
        mYAxis.calculate(0, mData.getYMax(AxisDependency.LEFT));
